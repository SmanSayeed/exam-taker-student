...
//     return (
//         <Card className="p-4 relative group shadow-md my-3 hover:shadow-lg duration-500 dark:bg-gray-50 dark:text-black ">
//             <CardTitle>
//                 <div className="mb-4 flex items-center justify-between gap-2">
//                     <div className="flex items-center gap-2">
//                         <p>{queIndex + 1}. </p>
//                         <p className="text-left font-hind-siliguri">{parseHtmlContent(title)} </p>
//                     </div>
//                     <div>
